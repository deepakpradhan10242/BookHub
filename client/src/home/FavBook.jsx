  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2'>
            ...
            <span className='text-green-700'> Book Here!</span> </h2>
            <p className='mb-10 text-lg md:w-5/6'>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
                Porro debitis culpa cumque? Enim error quibusdam alias ab? Deserunt reprehenderit eum pariatur! 
                Accusamus fugiat nobis obcaecati molestiae ab minus quod ipsum!
            </p>
            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
                ...
                <div>
                    ...
                    <p className='text-base'>Registered Sellers</p>
                </div>
                <div>
