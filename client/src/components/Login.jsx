			...
			<div className="max-w-md mx-auto">
				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        {error ? <p className='text-sm text-red-600 text-base'>Check Email or Password !</p> : ""}
                        <p className='text-sm'>New User ? click <Link to="/sign-up" className='text-blue-700 underline'>Sign Up</Link></p>
						<div className="relative">
							<button className="bg-green-500 text-white rounded-md px-6 py-2">Login</button>
						</div>
					</form>
				</div>
